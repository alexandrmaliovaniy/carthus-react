        ...
        overrides: [
            {
                ...
                inject: {
                    ...
                    content: [
                        "type I{{NAME}}ServiceProps = Parameters<typeof {{ARGS.NAME}}Service>",
                        "export const {{ARGS.NAME}}Provider: FC<{ children: ReactNode; props: I{{NAME}}ServiceProps }> = ({children, props = []}) => {\n\tconst service = {{ARGS.NAME}}Service(...props);\n\treturn <{{ARGS.NAME}}Context.Provider value={service}>{children}</{{ARGS.NAME}}Context.Provider>\n}"
                    ],
                    export: [
